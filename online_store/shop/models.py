...
class Product(models.Model):
    ...
    product_video = models.FileField(upload_to='vid/', verbose_name='Bидeo', null=True, blank=True)
...
class Rating (models.Model):
    ...
    stars = models.IntegerField(choices= [(i, str(i)) for i in range(1, 6)], verbose_name="Рeйтинг")
